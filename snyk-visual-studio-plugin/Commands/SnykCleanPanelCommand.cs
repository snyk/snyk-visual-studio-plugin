...
namespace Snyk.VisualStudio.Extension.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SnykCleanPanelCommand
    {
        /// <summary>
        ...
        private SnykCleanPanelCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var menuCommandID = new CommandID(SnykExtension.Guids.SnykVSPackageCommandSet, SnykExtension.Guids.CleanCommandId);
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            snykPackage.ToolWindowControl.Clean();
        }
    }
}
