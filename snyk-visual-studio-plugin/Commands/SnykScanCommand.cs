...
namespace Snyk.VisualStudio.Extension.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SnykScanCommand
    { 
        /// <summary>
        ...
        private SnykScanCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var menuCommandID = new CommandID(SnykExtension.Guids.SnykVSPackageCommandSet, SnykExtension.Guids.RunScanCommandId);
        ...
        private void Execute(object sender, EventArgs e) => SnykTasksService.Instance.Scan();
    }
}
