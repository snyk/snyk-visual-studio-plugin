...
namespace Snyk.VisualStudio.Extension.Commands
{
    ...
    { 
        ...
        private SnykScanCommand(AsyncPackage package, OleMenuCommandService commandService) : base(package, commandService)
        {
        }
        ...
        /// </summary>
        public static SnykScanCommand Instance
        {
            get;
            private set;
        }
        ...
        protected override int GetCommandId() => SnykExtension.Guids.RunScanCommandId;
    }
}
