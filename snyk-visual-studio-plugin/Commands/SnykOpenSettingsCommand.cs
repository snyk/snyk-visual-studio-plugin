...
namespace Snyk.VisualStudio.Extension.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class SnykOpenSettingsCommand
    {
        /// <summary>
        ...
        private SnykOpenSettingsCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var menuCommandID = new CommandID(SnykExtension.Guids.SnykVSPackageCommandSet, SnykExtension.Guids.OptionsCommandId);
        ...
        {
            var snykPackage = this.package as SnykVSPackage;

            snykPackage.ShowOptionPage();
        }
    }
}
