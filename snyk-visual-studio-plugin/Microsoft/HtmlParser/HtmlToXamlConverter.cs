...
namespace Microsoft.HtmlConverter
{
    ...
    public static class HtmlToXamlConverter
    {
        ...
        /// </summary>
        /// <param name="htmlString">The htmlString<see cref="string"/>.</param>
        /// <param name="asFlowDocument">The asFlowDocument<see cref="bool"/>.</param>
        ...
        /// </summary>
        /// <param name="element">The element<see cref="XmlElement"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlParentElement">The xamlParentElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlNode">The htmlNode<see cref="XmlNode"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlParentElement">The xamlParentElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlElementName">The htmlElementName<see cref="string"/>.</param>
        ...
        /// The AddTextRun.
        /// </summary>
        /// <param name="xamlElement">The xamlElement<see cref="XmlElement"/>.</param>
        /// <param name="textData">The textData<see cref="string"/>.</param>
        ...
        /// <summary>
        /// Defines the InlineFragmentParentElement.
        /// </summary>
        ...
        /// <summary>
        /// The DefineInlineFragmentParent.
        /// </summary>
        /// <param name="htmlComment">The htmlComment<see cref="XmlComment"/>.</param>
        /// <param name="xamlParentElement">The xamlParentElement<see cref="XmlElement"/>.</param>
        ...
        /// <summary>
        /// The ExtractInlineFragment.
        /// </summary>
        /// <param name="xamlFlowDocumentElement">The xamlFlowDocumentElement<see cref="XmlElement"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlParentElement">The xamlParentElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlListElement">The htmlListElement<see cref="XmlElement"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">.</param>
        /// <param name="sourceContext">.</param>
        ...
        /// </summary>
        /// <param name="xamlParentElement">The xamlParentElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlLIElement">The htmlLIElement<see cref="XmlElement"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        /// <param name="sourceContext">The sourceContext<see cref="List{XmlElement}"/>.</param>
        /// <returns>The <see cref="XmlElement"/>.</returns>
        ...
        /// </summary>
        /// <param name="xamlListElement">The xamlListElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlLIElement">The htmlLIElement<see cref="XmlElement"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        /// <param name="sourceContext">The sourceContext<see cref="List{XmlElement}"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlParentElement">The xamlParentElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlTableElement">The htmlTableElement<see cref="XmlElement"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        /// <param name="sourceContext">The sourceContext<see cref="List{XmlElement}"/>.</param>
        ...
        /// <summary>
        /// The GetCellFromSingleCellTable.
        /// </summary>
        /// <param name="htmlTableElement">The htmlTableElement<see cref="XmlElement"/>.</param>
        /// <returns>The <see cref="XmlElement"/>.</returns>
        ...
        /// </summary>
        /// <param name="htmlTableElement">The htmlTableElement<see cref="XmlElement"/>.</param>
        /// <param name="xamlTableElement">The xamlTableElement<see cref="XmlElement"/>.</param>
        /// <param name="columnStartsAllRows">The columnStartsAllRows<see cref="ArrayList"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlTableElement">The xamlTableElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlColgroupElement">The htmlColgroupElement<see cref="XmlElement"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        /// <param name="sourceContext">The sourceContext<see cref="List{XmlElement}"/>.</param>
        ...
        /// <param name="htmlColElement">The htmlColElement<see cref="XmlElement"/>.</param>
        /// <param name="inheritedProperties">The inheritedProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">.</param>
        /// <param name="sourceContext">.</param>
        ...
        /// </summary>
        /// <param name="xamlTableBodyElement">The xamlTableBodyElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlTRStartNode">The htmlTRStartNode<see cref="XmlNode"/>.</param>
        /// <param name="currentProperties">The currentProperties<see cref="Hashtable"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlTableRowElement">The xamlTableRowElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlTDStartNode">The htmlTDStartNode<see cref="XmlNode"/>.</param>
        /// <param name="currentProperties">The currentProperties<see cref="Hashtable"/>.</param>
        /// <param name="columnStarts">The columnStarts<see cref="ArrayList"/>.</param>
        /// <param name="activeRowSpans">The activeRowSpans<see cref="ArrayList"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        /// <param name="sourceContext">The sourceContext<see cref="List{XmlElement}"/>.</param>
        /// <returns>The <see cref="XmlNode"/>.</returns>
        ...
        /// </summary>
        /// <param name="xamlTableCellElement">The xamlTableCellElement<see cref="XmlElement"/>.</param>
        /// <param name="htmlDataStartNode">The htmlDataStartNode<see cref="XmlNode"/>.</param>
        /// <param name="currentProperties">The currentProperties<see cref="Hashtable"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        /// <param name="sourceContext">The sourceContext<see cref="List{XmlElement}"/>.</param>
        ...
        /// </summary>
        /// <param name="htmlTbodyElement">The htmlTbodyElement<see cref="XmlElement"/>.</param>
        /// <param name="columnStarts">The columnStarts<see cref="ArrayList"/>.</param>
        /// <param name="activeRowSpans">The activeRowSpans<see cref="ArrayList"/>.</param>
        /// <param name="tableWidth">The tableWidth<see cref="double"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        ...
        /// </summary>
        /// <param name="htmlTRElement">The htmlTRElement<see cref="XmlElement"/>.</param>
        /// <param name="columnStarts">The columnStarts<see cref="ArrayList"/>.</param>
        /// <param name="activeRowSpans">The activeRowSpans<see cref="ArrayList"/>.</param>
        /// <param name="tableWidth">The tableWidth<see cref="double"/>.</param>
        /// <param name="stylesheet">The stylesheet<see cref="CssStylesheet"/>.</param>
        ...
        /// </summary>
        /// <param name="htmlTDElement">The htmlTDElement<see cref="XmlElement"/>.</param>
        ...
        /// <param name="columnWidth">The columnWidth<see cref="double"/>.</param>
        /// <param name="columnStarts">The columnStarts<see cref="ArrayList"/>.</param>
        /// <param name="activeRowSpans">The activeRowSpans<see cref="ArrayList"/>.</param>
        /// <returns>.</returns>
        ...
        /// </summary>
        /// <param name="htmlTDElement">The htmlTDElement<see cref="XmlElement"/>.</param>
        /// <param name="columnStart">The columnStart<see cref="double"/>.</param>
        /// <returns>The <see cref="double"/>.</returns>
        ...
        /// <param name="isBlock">The isBlock<see cref="bool"/>.</param>
        ...
        /// <summary>
        /// The ComposeThicknessProperty.
        /// </summary>
        /// <param name="xamlElement">The xamlElement<see cref="XmlElement"/>.</param>
        /// <param name="propertyName">The propertyName<see cref="string"/>.</param>
        /// <param name="left">The left<see cref="string"/>.</param>
        /// <param name="right">The right<see cref="string"/>.</param>
        /// <param name="top">The top<see cref="string"/>.</param>
        /// <param name="bottom">The bottom<see cref="string"/>.</param>
        ...
        private static Hashtable GetElementProperties(XmlElement htmlElement, Hashtable inheritedProperties, out Hashtable localProperties, CssStylesheet stylesheet, List<XmlElement> sourceContext)
        {
            ...
            switch (elementName)
            {
                ...
                case "font":
                    ...
                    break;
                case "samp":
                    localProperties["font-family"] = "Mono"; // code sample
        ...
        /// </summary>
        /// <param name="cssStyle">The cssStyle<see cref="string"/>.</param>
        /// <param name="attributeName">The attributeName<see cref="string"/>.</param>
        /// <returns>The <see cref="string"/>.</returns>
        ...
        /// </summary>
        /// <param name="lengthAsString">The lengthAsString<see cref="string"/>.</param>
        ...
        /// The GetColorValue.
        /// </summary>
        /// <param name="colorValue">The colorValue<see cref="string"/>.</param>
        /// <returns>The <see cref="string"/>.</returns>
        ...
        /// </summary>
        /// <param name="htmlChildNode">The htmlChildNode<see cref="XmlElement"/>.</param>
        /// <param name="xamlTableCellElement">The xamlTableCellElement<see cref="XmlElement"/>.</param>
        ...
        // ---------------------------------------------------------------------
        /// <summary>
        /// Defines the _xamlNamespace.
        /// </summary>
        internal static string _xamlNamespace = "http://schemas.microsoft.com/winfx/2006/xaml/presentation";
    }
}
