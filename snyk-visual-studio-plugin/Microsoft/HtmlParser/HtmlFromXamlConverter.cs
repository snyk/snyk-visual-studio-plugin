...
namespace Microsoft.HtmlConverter
{
    ...
    internal static class HtmlFromXamlConverter
    {
        ...
        /// </summary>
        /// <param name="xamlString">The xamlString<see cref="string"/>.</param>
        ...
        /// </summary>
        /// <param name="xamlReader">The xamlReader<see cref="XmlTextReader"/>.</param>
        /// <param name="htmlWriter">The htmlWriter<see cref="XmlTextWriter"/>.</param>
        ...
        /// <param name="xamlReader">The xamlReader<see cref="XmlTextReader"/>.</param>
        /// <param name="htmlWriter">The htmlWriter<see cref="XmlTextWriter"/>.</param>
        /// <param name="inlineStyle">The inlineStyle<see cref="StringBuilder"/>.</param>
        ...
        /// <summary>
        /// The ParseXamlThickness.
        /// </summary>
        /// <param name="thickness">The thickness<see cref="string"/>.</param>
        /// <returns>The <see cref="string"/>.</returns>
        ...
        /// </summary>
        /// <param name="xamlReader">The xamlReader<see cref="XmlReader"/>.</param>
        /// <returns>The <see cref="bool"/>.</returns>
