...
//---------------------------------------------------------------------------
//
// Original source code here - https://github.com/microsoft/WPF-Samples/tree/master/Sample%20Applications/HtmlToXamlDemo
//
// StringBuilder
//
// important TODOS: 
...
namespace Microsoft.HtmlConverter
{
    ...
    {
        /// <summary>
        /// Prevents a default instance of the <see cref="HtmlParser"/> class from being created.
        /// </summary>
        /// <param name="inputString">The inputString<see cref="string"/>.</param>
        private HtmlParser(string inputString)
        {
            ...
            openedElements = new Stack<XmlElement>();

            pendingInlineElements = new Stack<XmlElement>();
        ...
        /// </summary>
        /// <param name="htmlDataString">The htmlDataString<see cref="string"/>.</param>
        ...
        /// The AddEmptyElement.
        /// </summary>
        /// <param name="htmlEmptyElement">The htmlEmptyElement<see cref="XmlElement"/>.</param>
        private void AddEmptyElement(XmlElement htmlEmptyElement)
        {
            ...
            XmlElement htmlParent = openedElements.Peek();
            htmlParent.AppendChild(htmlEmptyElement);
        }

        /// <summary>
        /// The OpenInlineElement.
        /// </summary>
        /// <param name="htmlInlineElement">The htmlInlineElement<see cref="XmlElement"/>.</param>
        ...
        private void OpenStructuringElement(XmlElement htmlElement)
        {
            ...
            if (HtmlSchema.IsBlockElement(htmlElement.LocalName))
            {
                ...
                {
                    XmlElement htmlInlineElement = openedElements.Pop();
        ...
        {
            foreach (XmlElement openedElement in openedElements)
            {
        ...
        private void CloseElement(string htmlElementName)
        {
            ...
            if (pendingInlineElements.Count > 0 && pendingInlineElements.Peek().LocalName == htmlElementName)
            {
                ...
                XmlElement htmlInlineElement = pendingInlineElements.Pop();
                InvariantAssert(openedElements.Count > 0, "CloseElement: Stack of opened elements cannot be empty, as we have at least one artificial root element");
                XmlElement htmlParent = openedElements.Peek();
            ...
            else if (IsElementOpened(htmlElementName))
            {
                while (openedElements.Count > 1) // we never pop the last element - the artificial root
                {
                    ...
                    XmlElement htmlOpenedElement = openedElements.Pop();
        ...
        /// The AddTextContent.
        /// </summary>
        /// <param name="textContent">The textContent<see cref="string"/>.</param>
        ...
        /// <summary>
        /// Defines the openedElements.
        /// </summary>
        internal Stack<XmlElement> openedElements;

        /// <summary>
        /// Defines the pendingInlineElements.
        /// </summary>
        internal Stack<XmlElement> pendingInlineElements;
    }
}
